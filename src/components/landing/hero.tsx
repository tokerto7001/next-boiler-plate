    ...
    return (
        <div className="flex w-full h-full gap-8 min-h-96">
            <div className="w-1/2 flex flex-col gap-9 justify-center">
                ...
                <h3 className="text-lg">Join our community of thinkers, creators, and dreamers. Explore curated content across a wide range of topics, crafted to spark your curiosity and fuel your passions...</h3>
