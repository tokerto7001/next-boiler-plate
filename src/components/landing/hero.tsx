    ...
    return (
        <div className="md:flex w-full h-full md:gap-8 min-h-96 flex flex-col gap-8 items-center md:flex-row md:justify-center md:items-stretch">
            <div className="md:w-1/2 flex flex-col gap-9 justify-center md:justify-center md:min-h-full">
                <h1 className="md:text-3xl text-2xl text-primary-main text-center md:text-start">Discover Insights That Inspire</h1>
                <h3 className="md:text-lg text-md text-center md:text-start">Join our community of thinkers, creators, and dreamers. Explore curated content across a wide range of topics, crafted to spark your curiosity and fuel your passions...</h3>
